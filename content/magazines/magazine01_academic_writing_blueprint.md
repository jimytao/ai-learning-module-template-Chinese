...
<img src="images/magazine01_reader_expectation.jpg" height="150" alt="Scholar studying essay architecture" />
...
<div class="viz-blocks" data-viz-id="B01" data-orientation="LR">
  <div class="viz-blocks-row">
    <div class="viz-block">
      <div class="viz-block-title">1. Macro Structure</div>
      <div class="viz-block-body">Cấu trúc phân tầng rõ ràng (Hourglass Model, Topic Sentences, Transitions)</div>
    </div>
    <div class="viz-arrow" aria-hidden="true">→</div>
    <div class="viz-block viz-block-accent">
      <div class="viz-block-title">2. Critical Logic</div>
      <div class="viz-block-body">Lập luận chặt chẽ (Claim + Evidence + Warrant, Toulmin Model)</div>
    </div>
    <div class="viz-arrow" aria-hidden="true">→</div>
    <div class="viz-block">
      <div class="viz-block-title">3. Scholarly Register</div>
      <div class="viz-block-body">Ngữ vực học thuật chuẩn xác (Objective Tone, Hedging, Precision)</div>
    </div>
  </div>
  <p class="viz-caption">Hình B01: Động cơ 3 trụ cột của văn phong học thuật chuẩn mực</p>
</div>
...
<img src="images/magazine01_thesis_engine.jpg" height="150" alt="Student formulating a thesis statement" />
...
```mermaid
flowchart LR
  Step1["1. Raw Topic<br>(Chủ đề thô)"] --> Step2["2. Focused Stance<br>(Lập trường có tính tranh biện)"]
  Step2 --> Step3["3. The 'Because/By' Rationale<br>(Lý do & Cơ chế)"]
  Step3 --> Step4["4. Academic Thesis<br>(Câu luận điểm chuẩn mực)"]
```

<!-- visual: formula | id: M01 | title: The 3-Part Thesis Formula | purpose: 公式化展示有效论点的构成要素 -->
<div class="viz-formula" data-viz-id="M01">
  <div class="viz-formula-main">Thesis = [Specific Topic] + [Arguable Claim] + [Blueprint / Rationale (Why/How)]</div>
  <div class="viz-formula-note">Công thức: [Chủ đề cụ thể] + [Lập trường có thể phản biện] + [Lý do / Lộ trình chứng minh (Vì sao / Bằng cách nào)]</div>
</div>
...
<div class="sticky-note warn-note">
  ...
  <p>Nếu câu Thesis của bạn là <em>"Trẻ em cần được giáo dục tốt để có tương lai tươi sáng"</em>, thì câu đối nghịch sẽ là <em>"Trẻ em không nên được giáo dục"</em>. Vì không ai có thể bảo vệ câu đối nghịch ngớ ngẩn này, nên câu ban đầu của bạn <strong>không phải là một Thesis Statement học thuật</strong>, mà chỉ là một lời tuyên bố đạo đức vô giá trị trong nghiên cứu.</p>
</div>
...
<img src="images/magazine01_scholarly_stance.jpg" height="150" alt="Academic writing with scholarly persona" />
...
<div class="sticky-note">
  ...
  <p>Thay vì viết <em>"I think this policy is ineffective"</em>, bạn hãy viết <em>"A rigorous analysis of recent fiscal outcomes reveals significant policy inefficacy."</em> Bằng cách biến <strong>bằng chứng và phương pháp</strong> thành chủ ngữ, bài viết của bạn sẽ lập tức toát lên sức nặng khách quan và uy tín học thuật.</p>
</div>
...
<div class="sticky-note">
  ...
  <p>1. <strong>Kiến trúc định hướng (Reader Expectation)</strong>: Viết học thuật tuân theo mô hình Chiếc đồng hồ cát (The Hourglass Model) — rõ ràng, có thể dự đoán và tuyệt đối không giấu giếm luận điểm như tiểu thuyết trinh thám.</p>
  <p>2. <strong>Luận điểm có tính phản biện (Arguable Thesis)</strong>: Một Thesis Statement vững chắc phải hội đủ 3 yếu tố: <code>Chủ đề cụ thể + Lập trường có thể tranh biện + Lộ trình lý giải (Why/How)</code>.</p>
  <p>3. <strong>Phong thái học giả (Scholarly Voice)</strong>: Sức mạnh thuyết phục của văn phong học thuật đến từ sự chuẩn xác của từ ngữ chuyên ngành và kỹ thuật diễn đạt dè dặt (Hedging) có căn cứ, chứ không đến từ những khẳng định cảm tính hay tuyệt đối hóa.</p>
</div>
